var frt_spots = {
	'spots':[
	// {
	// 	'hover': '<u><b>Liver</b></u>',//the hover content of this spot
	// 	'pos_X':445.5,// X position, to get the accurate value, please check the documentation folder.
	// 	'pos_Y':523.4,// Y position, to get the accurate value, please check the documentation folder.
	// 	'diameter':15,// diameter of this spot
